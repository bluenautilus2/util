--
-- 2014-10-02_14111608017_DEVELOPER_ONLY.cql  - DEVELOPER ONLY SCRIPT
...
--
-- Contains the necessary system properties to start 2.0
--
-- SQLRUNNER:NO_RUN
...
VALUES ('com.pa.common.email.redirect.address', '%CHANGE_ME%', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.persistence.ehcache.jgroups.multicast.addr', '%CHANGE_ME%', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.persistence.ehcache.jgroups.multicast.port', '%CHANGE_ME%', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.web.testing.ehcache.jgroups.multicast.addr', '%CHANGE_ME%', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.web.testing.ehcache.jgroups.multicast.port', '%CHANGE_ME%', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES
  ('com.pa.web.company.shared_data.jgroups.udp.mcast_addr', '%CHANGE_ME%', 'Must match [sharedDataMulticastAddr] in 1.0 config', 2, '18214998', DATEOF(NOW()),
   '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES
  ('com.pa.web.company.shared_data.jgroups.udp.mcast_port', '%CHANGE_ME%', 'Must match [sharedDataMulticastPort] in 1.0 config', 2, '18214998', DATEOF(NOW()),
   '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.web.internal.shared_data.jgroups.udp.mcast_addr', '%CHANGE_ME%', 'Must match [sharedInternalDataMulticastAddr] in 1.0 config', 2, '18214998',
        DATEOF(NOW()), '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.web.internal.shared_data.jgroups.udp.mcast_port', '%CHANGE_ME%', 'Must match [sharedInternalDataMulticastPort] in 1.0 config', 2, '18214998',
        DATEOF(NOW()), '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.permalink.domainName', '%CHANGE_ME%', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));
------------------------------------------------------
...
INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.common.email.behavior', 'REDIRECT', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));
...
INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.common.message.bus.hostname1', 'nucleus', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.common.message.bus.hostname2', 'nucleus', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));
...
INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.site.baseDomain', 'localhost', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));
...
INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.persistence.blofeld.ipAddress1', 'nucleus', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.persistence.blofeld.ipAddress2', 'nucleus', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));
...
INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.persistence.solr.zookeeper.hosts', 'nucleus:2181', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));
...
INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.services.resume.parsing.hostname1', 'girt.infor.com', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.services.resume.parsing.hostname2', 'girt.infor.com', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));
...
INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.web.testing.sharedSession.server1', 'nucleus:11211', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.web.testing.thawteseal.hostname', 'rc1.peopleanswers.com', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));
...
INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.web.company.businessUnitLogo.url.base', 'https://rc1.peopleanswers.com', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));
...
INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.web.company.sharedSession.server1', 'nucleus:11211', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));
...
INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.web.internal.sharedSession.server1', 'nucleus:11211', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));
...
INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.services.document.converter.hostname1', 'nucleus', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));

INSERT INTO default_system_configuration_properties (name, value, description, architecture, created_by, created_date, last_updated_by, last_updated_date)
VALUES ('com.pa.services.document.converter.hostname2', 'nucleus', '', 2, '18214998', DATEOF(NOW()), '18214998', DATEOF(NOW()));
