...
# This script is for Linux users; make sure you have the Perl DateTime module 
...
print $fh "--\n";
print $fh "-- AUTHOR: Beth Stevens (Beth.Stevens\@infor.com) \n";
print $fh "--\n";
print $fh "\n";
if($cass){
  print $fh "use pa;"
...
print $fh "\n";
print $fh "DECLARE @userId INT = 23823980;"; 
if(!$cass){
...
print $rh "--\n";
print $rh "-- AUTHOR: Beth Stevens (Beth.Stevens\@infor.com) \n";
print $rh "--\n";
print $rh "\n";
if($cass){
  print $rh "use pa;";
