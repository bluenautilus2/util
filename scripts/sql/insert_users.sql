...
SELECT agencyuser.add_RA('test345@test.com', 'Donald','','Trump');
SELECT agencyuser.add_RA('test4@test.com', 'Donald','','Trump');
SELECT agencyuser.add_RA('test5@test.com', 'Donald','','Trump');
SELECT agencyuser.add_RA('test6@test.com', 'Donald','','Trump');
commit;
